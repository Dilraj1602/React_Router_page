    ...
    <div className="text-white relative w-[1160px] mx-auto ">
      ...
      <div className="flex flex-col absolute top-11 left-0 space-y-6 w-[450px]">
        ...
        <div className='flex flex-col space-y-1'>
          ...
          <input type="email" id="email" placeholder="Enter Your Email Address" className="w-[420px] h-[40px] px-2 rounded-md bg-[rgb(22,29,41)]" />
        </div>

        <div className='flex flex-col relative mt-12 space-y-1'>
          <label htmlFor="password">Password</label>
          <input type="text" id="password" placeholder="Enter Password" className="w-[420px] h-[40px] px-2 rounded-md  bg-[rgb(22,29,41)]" />
        ...
        <button className='w-[420px] bg-yellow-400 py-[12px] px-[18px] rounded-[8px]
         font-medium text-[rgb(0,8,20)] '>Sign in</button>
        </div>
      ...
      <div>
        <img src={loginimage} alt="login" className="w-[440px] h-[390px] object-cover absolute z-[10] right-5 top-11" />
        <img src={background} alt="background" className="w-[440px] h-[390px] object-cover absolute z-[0] right-1 top-16" />
      </div>
